class PurchaserAddress
  ...
  attr_accessor :postal_code, :prefecture_id, :city, :house_number, :building, :phone_number, :token

  validates :post_code, :prefecture, :city, :house_number, :phone_number, :token, presence: true
